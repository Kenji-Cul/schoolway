    ...
    <ul>
        ...
        <li><?php 
                   ...
                   <?php if(empty($value['photo'])){?>
                    <img src="images/teacher3.jpg"  style="border-radius:50%; height:4rem; width:4rem;">
                    <?php }else{?>
...
<h1 class="heading">Technical Drawing</h1>
<h3 class="title">Topics</h3>

<div class="card-container">
<?php 
        $student = new User;
        $subject = $student->display_subject('Technical Drawing');
        $counter = 0;
