    ...
    <?php 
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                if(empty($_POST['password']) || $_POST['password']==""){
                   ...
                   $errormsg = "<div class='alert alert-danger'>Password must be more than 8 characters</div>";
                    ...
                    $student = new User;
                    $studentdetails = $student->createTeacher(check_input($_POST['name']),check_input($_POST['email']),check_input($_POST['password']));
                    echo $studentdetails;
                }
        ...
        <div class="row no-gutters" id="rowguy">
            ...
            <div class="col-lg-7 px-5 pt-5">
                <h1 class="font-weight-bold py-3">Sign Up As A Teacher</h1>
